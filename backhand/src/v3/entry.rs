...
use super::data::Added;
use super::dir::{Dir, DirEntry, DirInodeId};
...
use super::unix_string::OsStrExt;
        ...
        let dir_inode = if file_size > u16::MAX as usize {
            ...
            Inode::new(
                ...
                InodeInner::BasicDirectory(BasicDirectory {
                    ...
                    offset: block_offset.try_into().unwrap(),
                    start_block: block_index,
                    parent_inode: parent_inode.try_into().unwrap(),
                }),
            )
        };
    ...
    fn create_dir(creating_dir: &Vec<&Self>, start: u32, lowest_inode: u32) -> Dir {
        ...
        for e in creating_dir {
            ...
            let new_entry = DirEntry {
                ...
                t: match e.t.into_base_type() {
                    InodeId::BasicDirectory => DirInodeId::BasicDirectory,
                    InodeId::BasicFile => DirInodeId::BasicFile,
                    InodeId::BasicSymlink => DirInodeId::BasicSymlink,
                    InodeId::BasicBlockDevice => DirInodeId::BasicBlockDevice,
                    InodeId::BasicCharacterDevice => DirInodeId::BasicCharacterDevice,
                    InodeId::BasicNamedPipe => DirInodeId::BasicNamedPipe,
                    InodeId::BasicSocket => DirInodeId::BasicSocket,
                    InodeId::ExtendedDirectory => DirInodeId::ExtendedDirectory,
                    InodeId::ExtendedFile => DirInodeId::ExtendedFile,
                    InodeId::ExtendedSymlink => DirInodeId::ExtendedSymlink,
                    InodeId::ExtendedBlockDevice => DirInodeId::ExtendedBlockDevice,
                    InodeId::ExtendedCharacterDevice => DirInodeId::ExtendedCharacterDevice,
                    InodeId::ExtendedNamedPipe => DirInodeId::ExtendedNamedPipe,
                    InodeId::ExtendedSocket => DirInodeId::ExtendedSocket,
                },
